...
let [homeCount, setHome] = useState(0);
let [awayCount, setAway] = useState(0);
    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={() => setHome(homeCount + 7)} className="homeButtons__touchdown">Home Touchdown</button>
          <button onClick={() => setHome(homeCount + 3)}className="homeButtons__fieldGoal">Home Field Goal</button>
        </div>
